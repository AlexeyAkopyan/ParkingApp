...
public class MainActivity extends AppCompatActivity
    ...
    private List<ParkingPlace> parking_book;
...
//            Log.i("TAG_DATE", String.valueOf(new Date().getTime()));
//            Log.i("TAG_DATE", String.valueOf(new Date(new Date().getTime() + 3600 * 1000 * 8 + 3600 * 1000)));
//            Log.i("TAG_DATE", String.valueOf(new Date(new Date().getTime())));
//
...
//    public static ImageView sentOrder(String PaymentId, ) {
//        int parkingId = selected_place.getId();
//        String carNum = "car" + car_number;
//        Date start = new Date(new Date().getTime() + random.nextInt(3600 * 1000 * 8) + 3600 * 1000);
//        Date finish = new Date(start.getTime() + 3600 * 1000);
//        String paymentInfo = "here comes some payment information " + PaymentId;
//        Order order = new Order(null, (long) parkingId, carNum, start.getTime(),
//                finish.getTime(), paymentInfo);
//        connection.sendOrder(order);
//    }
